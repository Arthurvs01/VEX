...
#define MyAppName "VEX - Gestor de Comandas"
#define MyAppVersion "1.1.0-beta"
#define MyAppPublisher "VEX"
#define MyAppExeName "Vex - Gestor de Pedidos.exe"
...
AppId={{A32B94D8-429D-4130-AD1C-A108E913B0B6}
AppName={#MyAppName}
...
OutputDir=C:\Users\Arthurvs01\Projetos\VEX
OutputBaseFilename=VEX - Setup {#MyAppVersion}
SetupIconFile=C:\Users\Arthurvs01\Projetos\VEX\Icon.ico
...
[Files]
Source: "C:\Users\Arthurvs01\Projetos\VEX\dist\Vex - Gestor de Pedidos\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Arthurvs01\Projetos\VEX\dist\Vex - Gestor de Pedidos\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
